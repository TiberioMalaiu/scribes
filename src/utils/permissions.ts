...
const PERMISSION_MAP: Record<ProjectRole, ReadonlyArray<Permission | '*'>> = {
  owner: ['*'],
  admin: [
    'project:read', 'project:write', 'project:delete', 'project:settings',
    'task:read', 'task:write', 'task:delete', 'task:assign',
...
export function hasPermission(userRole: ProjectRole | null | undefined, permission: Permission): boolean {
