...
export const getProjects = (): Promise<ProjectListResponse | Project[]> =>
  client.get<ProjectListResponse | Project[]>('/projects');
...
export const getProjectMembers = (projectId: string): Promise<ProjectMemberListResponse | ProjectMember[]> =>
  client.get<ProjectMemberListResponse | ProjectMember[]>(`/projects/${projectId}/members`);
